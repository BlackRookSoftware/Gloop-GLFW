...
public enum KeyType
{
	...
	private static final Map<Integer, KeyType> VALUE_MAP = new HashMap<Integer, KeyType>()
	{
		private static final long serialVersionUID = -6680439582933025636L;
		{
	 ...
	 */
	public static final KeyType getById(int glfwId)
	{
